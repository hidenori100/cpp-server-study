...
| STEP 0-2 | Rule of Zero — unique_ptr + 커스텀 deleter, EBO | ✅ 완료 | [velog](https://velog.io/@hidenori100/C-Rule-of-Zero) |
| STEP 0-3 | shared_ptr 제어 블록, shared_from_this | ✅ 완료 | velog 예정 |
